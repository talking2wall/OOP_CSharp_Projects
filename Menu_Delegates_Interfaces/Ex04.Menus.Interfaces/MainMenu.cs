...
{
    public class MainMenu : IChoicesObserver
    {
        ...
        public void SetMenuItem(string[] i_Path, string i_NameOfMenuItemToAdd, IMethods i_Method = null)
        {
        ...
        public void SetMenuItem(string i_NameOfMenuItemToAdd, IMethods i_Method = null)
        {
            addMenuItem(r_MainMenuItems, i_NameOfMenuItemToAdd, i_Method);
        }

        private void addMenuItem(List<MenuItem> i_MenuItemsToAddFor, string i_NameOfMenuItemToAdd, IMethods i_Method = null)
        {
            MenuItem menuItemToAdd = new MenuItem(i_MenuItemsToAddFor.Count, i_NameOfMenuItemToAdd, i_Method);
            menuItemToAdd.AttachObserver(this as IChoicesObserver);
        ...
        private void selectMenuItem(List<MenuItem> i_MenuItems)
        {
            ...
            Console.Clear();
            i_MenuItems[selection].doWhenChosen();
        }
        ...
        void IChoicesObserver.ChoiceSelected(MenuItem i_ChosenMenuItem)
        {
